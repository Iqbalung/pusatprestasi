...
trait Button {
    ...
    protected function style() {
        ...
        $this->add_responsive_control(
            'button_spacing',
            [
                'label'        => __( 'Bottom Spacing', 'eduvibe-core' ),
        ...
        $this->start_controls_tabs( 'button_style_tabs' );
            ...
            $this->start_controls_tab( 'button_normal', [ 'label' => __( 'Normal', 'eduvibe-core' ) ] );
            ...
            $this->start_controls_tab( 'button_hover', [ 'label' => __( 'Hover', 'eduvibe-core' ) ] );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default'    => 'eduVibe-button-hover-effect'
                ]
            );
