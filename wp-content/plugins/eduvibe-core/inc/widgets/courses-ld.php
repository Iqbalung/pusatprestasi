...
/*
 * EduVibe LearnDash Courses Widgets
 */ 
if( ! function_exists( 'eduvibe_ld_register_course_widget' ) ) :
	function eduvibe_ld_register_course_widget() {
	    register_widget( 'EduVibeCore_LD_Courses_Widget' );
	}
endif;

add_action( 'widgets_init', 'eduvibe_ld_register_course_widget' );

if( ! class_exists( 'EduVibeCore_LD_Courses_Widget' ) ) :
	class EduVibeCore_LD_Courses_Widget extends WP_Widget {

		function __construct() {
			parent::__construct(
				'EduVibeCore_LD_Courses_Widget',
				__( 'EduVibe Courses( LearnDash )',  'eduvibe-core' ),
				array( 'description' => __( 'EduVibe LearnDash Course Items',  'eduvibe-core' ), )
			);
		}
						...
						echo '<div class="eduvibe-recent-course-each-item">';
							...
							echo '<div class="media-body">';
								...
								echo '<div class="eduvibe-recent-course-price">';
									if ( $is_wc_product ) :
					                    echo eduvibe_get_wc_course_price( $meta_data['related_product'] );
					                else :
					                    echo eduvibe_get_ld_course_price( get_the_ID(), $course_options );
					                endif;
								echo '</div>';
							echo '</div>';
						echo '</div>';
