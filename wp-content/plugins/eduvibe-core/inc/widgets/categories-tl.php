...
/*
 * EduVibe Tutor LMS Categories Widgets
 */ 
if( ! function_exists( 'eduvibe_tl_register_categories_widget' ) ) :
	function eduvibe_tl_register_categories_widget() {
	    register_widget( 'EduVibeCore_TL_Categories_Widget' );
	}
endif;

add_action( 'widgets_init', 'eduvibe_tl_register_categories_widget' );

if( ! class_exists( 'EduVibeCore_TL_Categories_Widget' ) ) :
	class EduVibeCore_TL_Categories_Widget extends WP_Widget {

		function __construct() {
			parent::__construct(
				'EduVibeCore_TL_Categories_Widget',
				__( 'EduVibe Categories( Tutor LMS )',  'eduvibe-core' ),
				array( 'description' => __( 'EduVibe Tutor LMS Course Categories',  'eduvibe-core' ), )
			);
		}
