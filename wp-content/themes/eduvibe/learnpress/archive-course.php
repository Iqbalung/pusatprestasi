...
if ( isset( $_GET['course_preset'] ) && $_GET['course_preset'] == 5 ) :
	$column = array( 'eduvibe-col-lg-6 eduvibe-col-md-6 eduvibe-col-sm-12' );
endif;

if ( isset( $_GET['active_white_bg'] ) || eduvibe_get_config( 'lp_course_white_bg' ) ) :
	$eduvibe_course_container[] = 'active-white-bg';
endif;
