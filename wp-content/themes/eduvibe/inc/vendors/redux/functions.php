	...
	class EduVibe_Redux_Framework_Config {
        ...
        public function setSections() {
            ...
            if ( eduvibe_is_learndash_activated() ) :
                // LearnDash Course Archive settings
                $this->sections[] = array(
                    'subsection' => true,
                    'title'      => __( 'Courses Archive( LearnDash )', 'eduvibe' ),
                    'fields'     => array(
                        array(
                            'id'       => 'ld_course_style',
                            'type'     => 'select',
                ...
                $this->sections[] = array(
                    'subsection' => true,
                    'title'      => __( 'Course Single', 'eduvibe' ),
                    'fields'     => array(
                        array(
                        ...
                        array(
                            ...
                            'on'      => __( 'Enable', 'eduvibe' ),
                            'off'     => __( 'Disable', 'eduvibe' ),
                            'title'   => __( 'Course Access', 'eduvibe' ),
                            'default' => true
                        ),
                        array(
                            'id'      => 'ld_course_topics',
                            ...
                            'on'      => __( 'Enable', 'eduvibe' ),
                            'off'     => __( 'Disable', 'eduvibe' ),
                            'title'   => __( 'Course Topics', 'eduvibe' ),
                            'default' => true
                        ),
                        array(
                            'id'      => 'ld_course_skill_level',
                            'type'    => 'switch',
                            'on'      => __( 'Enable', 'eduvibe' ),
                            'off'     => __( 'Disable', 'eduvibe' ),
                            'title'   => __( 'Course Skill Level', 'eduvibe' ),
            ...
            if ( eduvibe_is_tutor_lms_activated() ) :
                ...
                $this->sections[] = array(
                    'subsection' => true,
                    'title'      => __( 'Courses Archive( Tutor LMS )', 'eduvibe' ),
                    'fields'     => array(
                        array(
